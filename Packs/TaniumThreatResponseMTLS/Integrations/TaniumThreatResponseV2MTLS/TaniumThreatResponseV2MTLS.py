...
def main():
    ...
    # [mTLS fork] "or ''": a credential holding only a certificate has no username.
    username = params.get("credentials", {}).get("identifier") or ""
    password = params.get("credentials", {}).get("password")
    client_certificate, client_certificate_passphrase = get_client_certificate_params(params.get("credentials"))
