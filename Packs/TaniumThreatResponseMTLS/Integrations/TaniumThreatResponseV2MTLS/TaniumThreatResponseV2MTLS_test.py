...
import TaniumThreatResponseV2MTLS
...
def mock_client():
    client = TaniumThreatResponseV2MTLS.Client(base_url=BASE_URL, password="TEST", username="TEST", api_version="4.x")
    return client
...
def test_convert_to_int(test_input, expected_output):
    ...
    res = TaniumThreatResponseV2MTLS.convert_to_int(test_input)
...
@pytest.mark.parametrize(
    ...
    [
        ({"testingFunctionFirst": 1, "testingFunctionSecond": 2}, {"TestingFunctionFirst": 1, "TestingFunctionSecond": 2}),
        (
...
def test_format_context_data(test_input, expected_output):
    ...
    assert TaniumThreatResponseV2MTLS.format_context_data(test_input) == expected_output
...
def test_get_intel_doc(requests_mock):
    ...
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/intels/423", json={"data": api_expected_response})
    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_intel_doc(MOCK_CLIENT, {"intel_doc_id": "423"})
...
def test_get_intel_docs_single(requests_mock):
    ...
    requests_mock.get(
        BASE_URL + "/plugin/products/threat-response/api/v1/intels/?name=test2", json={"data": api_expected_response[1]}
    )

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_intel_docs(MOCK_CLIENT, {"name": "test2"})
...
def test_get_intel_docs_multiple(requests_mock):
    ...
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/intels/", json={"data": api_expected_response})

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_intel_docs(MOCK_CLIENT, {})
    intel_docs = outputs.get("Tanium.IntelDoc(val.ID && val.ID === obj.ID)", [])
...
def test_get_intel_docs_labels_list(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + f"/plugin/products/detect3/api/v1/intels/{intel_doc_id}/labels", json=api_expected_response)
    requests_mock.get(
        BASE_URL + f"/plugin/products/threat-response/api/v1/intels/{intel_doc_id}/labels", json={"data": api_expected_response}
    )

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_intel_docs_labels_list(
        MOCK_CLIENT, {"intel_doc_id": intel_doc_id}
    )
...
def test_add_intel_docs_label(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    req = requests_mock.put(
        BASE_URL + f"/plugin/products/detect3/api/v1/intels/{intel_doc_id}/labels", json=api_expected_response
    )
    req_4 = requests_mock.put(
        BASE_URL + f"/plugin/products/threat-response/api/v1/intels/{intel_doc_id}/labels", json={"data": api_expected_response}
    )

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.add_intel_docs_label(
        MOCK_CLIENT, {"intel_doc_id": intel_doc_id, "label_id": label_id}
    )
...
def test_remove_intel_docs_label(requests_mock):
    ...
    requests_mock.delete(
        BASE_URL + f"/plugin/products/detect3/api/v1/intels/{intel_doc_id}/labels/{label_id}", json=api_expected_response
    )

    requests_mock.delete(
        BASE_URL + f"/plugin/products/threat-response/api/v1/intels/{intel_doc_id}/labels/{label_id}",
        json={"data": api_expected_response},
    )

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.remove_intel_docs_label(
        MOCK_CLIENT, {"intel_doc_id": intel_doc_id, "label_id": label_id}
    )
...
def test_create_intel_doc(mocker, requests_mock):
    ...
    mocker.patch("TaniumThreatResponseV2MTLS.get_file_data", return_value=("test_name", "test_data/test.ioc", file_content))
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.post(BASE_URL + "/plugin/products/detect3/api/v1/intels", json=api_expected_response)
    requests_mock.post(BASE_URL + "/plugin/products/threat-response/api/v1/intels", json={"data": api_expected_response})

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.create_intel_doc(
        MOCK_CLIENT, {"entry_id": entry_id, "file_extension": file_extension}
    )
...
def test_update_intel_doc_ioc(mocker, requests_mock):
    ...
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/intels/423", json={"data": api_get_expected_response})
    requests_mock.put(
        BASE_URL + f"/plugin/products/detect3/api/v1/intels/{str(intel_doc_id)}",
        json=api_update_expected_response,
        request_headers={"Content-Disposition": "attachment; filename=file.ioc", "Content-Type": "application/xml"},
    )
    requests_mock.put(
        BASE_URL + f"/plugin/products/threat-response/api/v1/intels/{str(intel_doc_id)}",
        json={"data": api_update_expected_response},
        request_headers={"Content-Disposition": "attachment; filename=file.ioc", "Content-Type": "application/xml"},
    )

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.update_intel_doc(
        MOCK_CLIENT, {"intel_doc_id": intel_doc_id, "entry_id": entry_id, "file_extension": file_extension}
    )
...
def test_update_intel_doc_yara(mocker, requests_mock):
    ...
    api_update_expected_response = util_load_json("test_data/update_intel_docs_raw_response.json")
    api_get_expected_response = util_load_json("test_data/get_intel_doc_raw_response.json")
    mocker.patch("TaniumThreatResponseV2MTLS.get_file_data", return_value=("test_name", "test_data/test.yara", file_content))
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/detect3/api/v1/intels/423", json=api_get_expected_response)
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/intels/423", json={"data": api_get_expected_response})
    requests_mock.put(
        BASE_URL + f"/plugin/products/detect3/api/v1/intels/{str(intel_doc_id)}",
        request_headers={"Content-Disposition": "filename=test123456", "Content-Type": "application/xml"},
        json=api_update_expected_response,
    )
    requests_mock.put(
        BASE_URL + f"/plugin/products/threat-response/api/v1/intels/{str(intel_doc_id)}",
        request_headers={"Content-Disposition": "attachment; filename=test123456", "Content-Type": "application/xml"},
        json={"data": api_update_expected_response},
    )
...
def test_delete_intel_doc(mocker, requests_mock):
    ...
    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.delete_intel_doc(MOCK_CLIENT, {"intel_doc_id": 431})
...
def test_start_quick_scan(mocker, requests_mock):
    ...
    requests_mock.post(
        BASE_URL + "/plugin/products/threat-response/api/v1/on-demand-scans/", json={"data": api_post_expected_response}
    )

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.start_quick_scan(
        MOCK_CLIENT, {"intel_doc_id": 431, "computer_group_name": "All Computers"}
    )
...
def test_deploy_intel(requests_mock):
    ...
    api_raw_response = {"data": {"taskId": 750}}
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.post(BASE_URL + "/plugin/products/threat-response/api/v1/intel/deploy", json=api_raw_response)

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.deploy_intel(MOCK_CLIENT, {})
...
def test_get_deploy_status(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/intel/status", json=api_raw_response)

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_deploy_status(MOCK_CLIENT, {})
...
def test_get_alerts(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/detect3/api/v1/alerts/", json=api_raw_response)
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/alerts/", json={"data": api_raw_response})

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_alerts(MOCK_CLIENT, {})
...
def test_get_alert(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/detect3/api/v1/alerts/1", json=api_raw_response)
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/alerts/1", json={"data": api_raw_response})

    human_readable, outputs, raw_response = TaniumThreatResponseV2MTLS.get_alert(MOCK_CLIENT, {"alert_id": 1})
...
def test_alert_update_state(requests_mock):
    ...
    args = {"alert_ids": "1,2,test", "state": "unresolved"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.alert_update_state(MOCK_CLIENT, args)
...
def test_create_snapshot(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.post(
        BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/snapshot", json=api_raw_response
    )

    args = {"connection_id": "remote:host:123:"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.create_snapshot(MOCK_CLIENT, args)
    assert "Initiated snapshot creation request for" in human_readable
    assert "Task id: 1" in human_readable
    assert (
        outputs.get("Tanium.SnapshotTask(val.taskId === obj.taskId && val.connection === obj.connection)", {}).get("taskId") == 1
    )
    assert (
        outputs.get("Tanium.SnapshotTask(val.taskId === obj.taskId && val.connection === obj.connection)", {}).get("connection")
        == "remote:host:123:"
    )
...
def test_delete_snapshot(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.delete(BASE_URL + "/plugin/products/threat-response/api/v1/snapshot", json={})

    args = {"snapshot_ids": "1,2,3"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.delete_snapshot(MOCK_CLIENT, args)
...
def test_list_snapshots(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/snapshot", json=api_raw_response)

    args = {"limit": 2, "offset": 0}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.list_snapshots(MOCK_CLIENT, args)
...
def test_delete_local_snapshot(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.delete(BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:", json={})

    args = {"connection_id": "remote:host:123:"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.delete_local_snapshot(MOCK_CLIENT, args)
...
def test_get_connections(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/conns", json=api_raw_response)

    args = {"limit": "2", "offset": "0"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_connections(MOCK_CLIENT, args)
...
@pytest.mark.parametrize("command_args, expected_output_len", FILTER_CONNECTIONS_LIST_ARGS)
def test_filter_get_connections(requests_mock, command_args, expected_output_len):
    """
    Given -
    ...
    _, outputs, _ = TaniumThreatResponseV2MTLS.get_connections(client=MOCK_CLIENT, command_args=command_args)
...
def test_create_connection(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.post(BASE_URL + "/plugin/products/threat-response/api/v1/conns/connect", content=b"remote:hostname:123:")

    args = {"ip": "1.1.1.1", "client_id": "123", "hostname": "hostname"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.create_connection(MOCK_CLIENT, args)
...
def test_delete_connection(requests_mock):
    ...
    args = {"connection_id": "remote:host:123:"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.delete_connection(MOCK_CLIENT, args)
...
def test_close_connection(requests_mock):
    ...
    args = {"connection_id": "remote:host:123:"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.close_connection(MOCK_CLIENT, args)
...
def test_get_events_by_connection(requests_mock):
    ...
    args = {"limit": "2", "offset": "0", "connection_id": "remote:hostname:123:", "type": "process"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_events_by_connection(MOCK_CLIENT, args)
...
def test_get_labels(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/detect3/api/v1/labels/", json=api_raw_response)
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/labels/", json={"data": api_raw_response})

    args = {"limit": "2", "offset": "0"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_labels(MOCK_CLIENT, args)
...
def test_get_label(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/detect3/api/v1/labels/1", json=api_raw_response)
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/labels/1", json={"data": api_raw_response})

    args = {"label_id": 1}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_label(MOCK_CLIENT, args)
...
def test_get_events_by_process(requests_mock):
    ...
    args = {"connection_id": "remote:host:123:", "limit": "2", "offset": "0", "ptid": "1", "type": "Process"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_events_by_process(MOCK_CLIENT, args)
...
def test_get_process_info(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(
        BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/processtrees/1", json=api_raw_response
    )

    args = {"connection_id": "remote:host:123:", "ptid": "1"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_process_info(MOCK_CLIENT, args)
...
def test_get_process_children(requests_mock):
    ...
    args = {"connection_id": "remote:host:123:", "ptid": "1"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_process_children(MOCK_CLIENT, args)
...
def test_get_parent_process(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(
        BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/processtrees/2", json=api_raw_response
    )

    args = {"connection_id": "remote:host:123:", "ptid": "2"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_parent_process(MOCK_CLIENT, args)
...
def test_get_process_tree(requests_mock):
    ...
    args = {"connection_id": "remote:host:123:", "ptid": "2"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_process_tree(MOCK_CLIENT, args)
...
def test_list_evidence(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/evidence", json=api_raw_response)

    args = {"limit": "2", "offset": "0"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.list_evidence(MOCK_CLIENT, args)
...
@pytest.mark.parametrize("command_args, expected_output_len", FILTER_EVIDENCE_LIST_ARGS)
def test_filter_list_evidence(requests_mock, command_args, expected_output_len):
    ...
    _, outputs, _ = TaniumThreatResponseV2MTLS.list_evidence(MOCK_CLIENT, command_args)
    response = outputs.get("Tanium.Evidence(val.uuid && val.uuid === obj.uuid)", {})
    assert len(response) == expected_output_len, f"Actual length: {len(response)}, Expected length: {expected_output_len}"
...
def test_event_evidence_get_properties(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/event-evidence/properties", json=api_raw_response)

    args = {}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.event_evidence_get_properties(MOCK_CLIENT, args)
...
def test_get_evidence_by_id(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/event-evidence/1", json=api_raw_response)

    args = {"evidence_id": "1"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_evidence_by_id(MOCK_CLIENT, args)
...
def test_create_evidence(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(
        BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/views/process/events", json=api_raw_response
    )
    requests_mock.post(BASE_URL + "/plugin/products/threat-response/api/v1/event-evidence", json={})

    args = {"connection_id": "remote:host:123:", "hostname": "host", "ptid": "1"}
    human_readable, _, _ = TaniumThreatResponseV2MTLS.create_evidence(MOCK_CLIENT, args)
...
def test_delete_evidence(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.delete(BASE_URL + "/plugin/products/threat-response/api/v1/event-evidence", json={})

    args = {"evidence_ids": "1,2,3"}
    human_readable, _, _ = TaniumThreatResponseV2MTLS.delete_evidence(MOCK_CLIENT, args)
...
def test_get_file_downloads(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/filedownload", json=api_raw_response)

    args = {"limit": "2"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_file_downloads(MOCK_CLIENT, args)
...
@pytest.mark.parametrize("command_args, expected_output_len", FILTER_FILE_DOWNLOADS_ARGS)
def test_filter_get_file_downloads(requests_mock, command_args, expected_output_len):
    ...
    _, outputs, _ = TaniumThreatResponseV2MTLS.get_file_downloads(MOCK_CLIENT, command_args)
...
def test_get_file_download_info(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/filedownload/1", json=api_raw_response)

    args = {"file_id": "1"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_file_download_info(MOCK_CLIENT, args)
...
def test_request_file_download(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.post(BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/file", json=api_raw_response)

    args = {"connection_id": "remote:host:123:", "path": "C:\\file.txt"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.request_file_download(MOCK_CLIENT, args)
    assert "Task id: 1" in human_readable
    assert (
        outputs.get("Tanium.FileDownloadTask(val.taskId === obj.taskId && val.connection === obj.connection)", {}).get("taskId")
        == 1
    )
    assert (
        outputs.get("Tanium.FileDownloadTask(val.taskId === obj.taskId && val.connection === obj.connection)", {}).get(
            "connection"
        )
        == "remote:host:123:"
    )
...
def test_delete_file_download(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.delete(BASE_URL + "/plugin/products/threat-response/api/v1/filedownload/1", json={})

    args = {"file_id": "1"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.delete_file_download(MOCK_CLIENT, args)
...
def test_list_files_in_dir(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(
        BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/file/list/C%3A%5CDir%5C", json=api_raw_response
    )

    args = {"connection_id": "remote:host:123:", "path": "C:\\Dir\\", "limit": "2", "offset": "0"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.list_files_in_dir(MOCK_CLIENT, args)
    assert "Files in directory" in human_readable
    assert (
        outputs.get("Tanium.File(val.name === obj.name && val.connectionId === obj.connectionId)", [{}])[0].get("name")
        == "file1.exe"
    )
    assert (
        outputs.get("Tanium.File(val.name === obj.name && val.connectionId === obj.connectionId)", [{}])[0].get("connectionId")
        == "remote:host:123:"
    )
...
def test_get_file_info(requests_mock):
    ...
    args = {"path": "C:\\file1.txt", "connection_id": "remote:host:123:"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_file_info(MOCK_CLIENT, args)
    assert "Information for file" in human_readable
    assert (
        outputs.get("Tanium.File(val.path === obj.path && val.connectionId === obj.connectionId)", {}).get("connectionId")
        == "remote:host:123:"
    )
    assert (
        outputs.get("Tanium.File(val.path === obj.path && val.connectionId === obj.connectionId)", {}).get("path")
        == "C:\\file1.txt"
    )
...
def test_delete_file_from_endpoint(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.delete(
        BASE_URL + "/plugin/products/threat-response/api/v1/conns/remote:host:123:/file/delete/C%3A%5Cfile1.txt", json={}
    )

    args = {"path": "C:\\file1.txt", "connection_id": "remote:host:123:"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.delete_file_from_endpoint(MOCK_CLIENT, args)
...
def test_get_task_by_id(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/tasks/1", json=api_raw_response)

    args = {"task_id": "1"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_task_by_id(MOCK_CLIENT, args)
...
def test_get_system_status(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/api/v2/system_status", json=api_raw_response)

    args = {"limit": 2, "offset": 0}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_system_status(MOCK_CLIENT, args)
...
@pytest.mark.parametrize("command_args, expected_output_len", FILTER_GET_SYSTEM_STATUS_ARGS)
def test_filter_get_system_status(requests_mock, command_args, expected_output_len):
    """
    Given -
    ...
    """
    api_raw_response = util_load_json("test_data/filter_get_system_status.json")
    ...
    _, outputs, _ = TaniumThreatResponseV2MTLS.get_system_status(MOCK_CLIENT, command_args)
    response = outputs.get("Tanium.SystemStatus(val.clientId === obj.clientId)", {})
    assert len(response) == expected_output_len, f"Actual length: {len(response)}, Expected length: {expected_output_len}"
...
def test_fetch_all_incidents(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(
        BASE_URL + "/plugin/products/detect3/api/v1/alerts?"
        "&state=unresolved&sort=-createdAt&limit=500&offset=0&labelName=some_label",
        json=test_incidents,
    )
    requests_mock.get(
        BASE_URL + "/plugin/products/threat-response/api/v1/alerts?"
        "&state=unresolved&sort=-createdAt&limit=500&offset=0&labelName=some_label",
    ...
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/intels/11/labels", json={"data": [{"name": "test"}]})
    ...
    incidents, next_run = TaniumThreatResponseV2MTLS.fetch_incidents(
        MOCK_CLIENT, alerts_states_to_retrieve, filter_label_name, last_run, fetch_time, max_fetch
    )

    assert len(incidents) == 2
    assert incidents[0].get("name") == "hostname found test"
    assert incidents[0].get("occurred") == "2021-09-26T14:01:31.000Z"
    assert next_run.get("id") == "2"
    assert next_run.get("time") == datetime.strftime(parse("2021-09-26T14:02:59.000Z"), TaniumThreatResponseV2MTLS.DATE_FORMAT)
...
def test_fetch_new_incidents(requests_mock):
    ...
    assert next_run.get("time") == datetime.strftime(parse("2021-09-26T14:04:59.000Z"), TaniumThreatResponseV2MTLS.DATE_FORMAT)
...
def test_get_response_actions(requests_mock):
        ...
        "data": [
            {
                ...
                "userId": 1,
                "userName": "test",
                "options": {"filePath": "C:\\Program Files (x86)\\log1.txt"},
                "results": {"taskIds": [34], "actionIds": [], "fileName": "test.zip"},
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.get(BASE_URL + "/plugin/products/threat-response/api/v1/response-actions", json=api_raw_response)

    args = {"limit": 2, "offset": 0, "partial_computer_name": "1", "status": "test"}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.get_response_actions(MOCK_CLIENT, args)
...
def test_response_action_gather_snapshot(requests_mock):
    ...
    requests_mock.post(BASE_URL + "/api/v2/session/login", json={"data": {"session": "session-id"}})
    requests_mock.post(BASE_URL + "/plugin/products/threat-response/api/v1/response-actions", json=api_raw_response)

    args = {"computer_name": 1}
    human_readable, outputs, _ = TaniumThreatResponseV2MTLS.response_action_gather_snapshot(MOCK_CLIENT, args)
    assert "Response Actions" in human_readable
...
def test_get_client_certificate_params(credentials_params, expected):
    ...
    """
    assert TaniumThreatResponseV2MTLS.get_client_certificate_params(*credentials_params) == expected
...
def test_build_client_certificate_pem(certificate_field):
    ...
    """
    assert TaniumThreatResponseV2MTLS.build_client_certificate_pem(certificate_field, "") == FAKE_CERTIFICATE + FAKE_KEY
...
def test_build_client_certificate_pem_keeps_the_certificate_chain():
    ...
    assert TaniumThreatResponseV2MTLS.build_client_certificate_pem(certificate_field, "") == certificate_field
...
def test_build_client_certificate_pem_keeps_legacy_encryption_headers():
    ...
    assert TaniumThreatResponseV2MTLS.build_client_certificate_pem(certificate_field, "passphrase") == expected_pem
...
def test_build_client_certificate_pem_invalid_field(certificate_field, passphrase, expected_error):
    ...
    with pytest.raises(DemistoException, match=expected_error) as error:
        TaniumThreatResponseV2MTLS.build_client_certificate_pem(certificate_field, passphrase)
...
def create_mtls_client(base_url: str, certificate_field: str = "", passphrase: str = "", verify: bool = True):
    return TaniumThreatResponseV2MTLS.Client(
        base_url,
        "user",
        "password",
        "4.x",
...
def test_mtls_request_presents_the_client_certificate(
    ...
    response = client._http_request("GET", "/api/v2/session/current")
...
def test_mtls_request_verifies_the_server_certificate(
    ...
    with pytest.raises(DemistoException, match=r"TLS handshake with the server failed \(client certificate presented\)") as error:
        client._http_request("GET", "/api/v2/session/current")
...
def test_main_presents_the_certificate_of_the_credential(monkeypatch, mtls_pki, mtls_server, trust_test_ca, mtls_temp_dir):
    """
    Given: an instance using a credential of the credentials store, whose Certificate field holds the certificate and key.
    ...
    params = {
        "url": mtls_server,
        "api_version": "4.x",
        "credentials": {"identifier": "user", "password": "password", "credentials": {"sshkey": certificate_field}},
    }
    command_results = []
    monkeypatch.setattr(demisto, "params", lambda: params)
    monkeypatch.setattr(demisto, "command", lambda: "tanium-tr-list-labels")
    monkeypatch.setattr(demisto, "args", dict)
    monkeypatch.setattr(
        TaniumThreatResponseV2MTLS, "get_labels", lambda client, args: ("", {}, client.do_request("GET", "/api/v2/labels"))
    )
    monkeypatch.setattr(TaniumThreatResponseV2MTLS, "return_results", lambda results: command_results.append(results))

    TaniumThreatResponseV2MTLS.main()

    assert command_results[0].raw_response == {"data": {"peer": MTLS_CLIENT_COMMON_NAME}}
    assert list(mtls_temp_dir.iterdir()) == []
